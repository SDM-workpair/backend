...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['member_id'], ['MR_Member.member_id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['member_id'], ['MR_Member.member_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['room_uuid'], ['MatchingRoom.room_uuid'], ),
    sa.ForeignKeyConstraint(['target_member_id'], ['MR_Member.member_id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['member_id'], ['MR_Member.member_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['rcmed_member_id'], ['MR_Member.member_id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['room_uuid'], ['MatchingRoom.room_uuid'], ),

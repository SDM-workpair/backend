...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "GR_Member", "Group", ["group_uuid"], ["group_uuid"], ondelete="CASCADE"
    )
    op.alter_column("Group", "room_uuid", existing_type=sa.UUID(), nullable=True)
    op.drop_constraint("Group_room_uuid_fkey", "Group", type_="foreignkey")
    op.create_foreign_key(
        None, "Group", "MatchingRoom", ["room_uuid"], ["room_uuid"], ondelete="SET NULL"
    )
    op.drop_constraint(
        "MR_Liked_Hated_Member_room_uuid_fkey",
    ...
    op.create_foreign_key(
        None, "MR_Member", "User", ["user_uuid"], ["user_uuid"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None,
        "MR_Member",
    ...
    op.drop_constraint(
        "MR_Member_Tag_room_uuid_fkey", "MR_Member_Tag", type_="foreignkey"
    )
    op.create_foreign_key(
        None,
        "MR_Member_Tag",
    ...
    op.drop_constraint(
        "MR_Rcmed_Member_room_uuid_fkey", "MR_Rcmed_Member", type_="foreignkey"
    )
    op.create_foreign_key(
        None,
        "MR_Rcmed_Member",
    ...
    op.drop_constraint(
        "MatchingEvent_room_uuid_fkey", "MatchingEvent", type_="foreignkey"
    )
    op.create_foreign_key(
        None,
        "MatchingEvent",
    ...
    op.drop_constraint(
        "NotificationTemplate_template_id_key", "NotificationTemplate", type_="unique"
    )
    op.drop_constraint("Tag_room_uuid_fkey", "Tag", type_="foreignkey")
    op.create_foreign_key(
        None, "Tag", "MatchingRoom", ["room_uuid"], ["room_uuid"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "Tag_room_uuid_fkey", "Tag", "MatchingRoom", ["room_uuid"], ["room_uuid"]
    )
    op.create_unique_constraint(
        "NotificationTemplate_template_id_key", "NotificationTemplate", ["template_id"]
    )
    op.drop_constraint(None, "MatchingEvent", type_="foreignkey")
    op.create_foreign_key(
        "MatchingEvent_room_uuid_fkey",
        "MatchingEvent",
        "MatchingRoom",
        ["room_uuid"],
        ["room_uuid"],
    ...
    op.create_foreign_key(
        "MR_Rcmed_Member_room_uuid_fkey",
        "MR_Rcmed_Member",
        "MatchingRoom",
        ["room_uuid"],
        ["room_uuid"],
    ...
    op.create_foreign_key(
        "MR_Member_user_uuid_fkey", "MR_Member", "User", ["user_uuid"], ["user_uuid"]
    )
    ...
    op.create_foreign_key(
        "Group_room_uuid_fkey", "Group", "MatchingRoom", ["room_uuid"], ["room_uuid"]
    )
    op.alter_column("Group", "room_uuid", existing_type=sa.UUID(), nullable=False)
    op.drop_constraint(None, "GR_Member", type_="foreignkey")
    op.create_foreign_key(
        "GR_Member_group_uuid_fkey",
        "GR_Member",
        "Group",
        ["group_uuid"],
        ["group_uuid"],
